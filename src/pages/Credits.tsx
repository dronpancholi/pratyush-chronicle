        ...
        <section className="py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              ...
              <Card className="mb-12 border-2 border-amber-200 shadow-lg">
                <CardHeader className="text-center pb-6">
                  ...
                  <p className="text-lg text-amber-600 font-semibold">President, Pratyush Club | Founder & Guide</p>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="text-center">
                    <p className="text-lg text-muted-foreground mb-6 max-w-3xl mx-auto leading-relaxed">
                      Visionary founder of the Pratyush Club and esteemed president who provided strategic guidance, 
                      supervision, and leadership throughout the project development. As the founding father of this initiative, 
                      his vision and direction have been instrumental in bringing this platform to life.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                      <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-6 mb-4">
                        ...
                        <h4 className="font-semibold text-foreground">Founder & President</h4>
                      </div>
                      <p className="text-sm text-muted-foreground">Pratyush Club establishment and leadership</p>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Project oversight and direction</p>
                    </div>

                    <div className="text-center">
                      <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-6 mb-4">
                        <Lightbulb className="h-8 w-8 text-amber-600 mx-auto mb-3" />
                        <h4 className="font-semibold text-foreground">Vision</h4>
                      </div>
                      <p className="text-sm text-muted-foreground">Newsletter initiative conceptualization</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="mb-12 border border-primary/20 shadow-md">
                <CardHeader className="text-center pb-8">
                  ...
                  <p className="text-lg text-primary font-semibold">Designer, Developer & Implementer</p>
                </CardHeader>
                <CardContent className="space-y-8">
                  <div className="text-center">
                    <p className="text-lg text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed">
                      Complete conceptualization, design, development, and implementation of the Pratyush Newsletter platform. 
                      All design, development, and implementation work has been carried out by Dron Pancholi under the 
                      guidance and supervision of Alaukik Dave. From initial concept to full deployment, every technical 
                      aspect has been meticulously crafted with dedication and precision.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="text-center">
                      <div className="bg-secondary/50 rounded-lg p-6 mb-4">
                        ...
                        <h4 className="font-semibold text-foreground">Technical Design</h4>
                      </div>
                      <p className="text-sm text-muted-foreground">Architecture and system planning</p>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Project deployment and delivery</p>
                    </div>
                  </div>
