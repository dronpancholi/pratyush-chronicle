...
-- Update profiles table to include department and role
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS department_id UUID REFERENCES public.departments(id),
ADD COLUMN IF NOT EXISTS email TEXT;

-- Update profiles role enum to include more specific roles
ALTER TABLE public.profiles 
...
-- Insert admin users (this will be done manually)
-- Admin: Dron Pancholi (dronpancholi@example.com)
-- President: Alaukik Dave (alaukikdave@example.com)